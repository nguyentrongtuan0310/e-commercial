    ...
    return (
        <Footer className={styles.footer}>
            <Row gutter={12} className={styles.footer__container}>
                <Col lg={{ span: 6 }} md={{ span: 12 }} sm={{ span: 12 }} className={styles.footer__content}>
                ...
                <Col lg={{ span: 6 }} md={{ span: 12 }} sm={{ span: 12 }} className={styles.info}>
                ...
                <Col lg={{ span: 6 }} md={{ span: 12 }} sm={{ span: 12 }} className={styles.connect}>
                    ...
                    <div className={styles.connect__support}>
                        ...
                        <img src={dt1} className={styles.connect__support__logo} alt="youtube" />
                        <p>Kênh thông tin giải trí công nghệ cho giới trẻ</p>
                        <img src={schanel} className={styles.connect__support__logo} alt="youtube" />
                        <p>Trang thông tin công nghệ mới nhất</p>
                        <img src={sforum} className={styles.connect__support__logo} alt="youtube" />
                    </div>
                </Col>
            </Row>
            <div className={styles.footer__bottom}>
                <Row className={styles.footer__container}>
                    <Col lg={{ span: 6 }} md={{ span: 12 }} sm={{ span: 12 }}>
                        <p className={styles.footer__container__text}>
                            Điện thoại - Điện thoại iPhone - Điện thoại iPhone 14
                        </p>
                    ...
                    <Col lg={{ span: 6 }} md={{ span: 12 }} sm={{ span: 12 }}>
                        <p className={styles.footer__container__text}>
                            Điện thoại Vivo – Điện thoại OPPO – Điện thoại Samsung
                        </p>
                ...
                <div className={styles.footer__bottom__box}>
                    {' '}
                    <p>
                        Công ty TNHH Thương Mại và Dịch Vụ Kỹ Thuật DIỆU PHÚC - GPĐKKD: 0316172372 cấp tại Sở KH & ĐT
                        TP. HCM. Địa chỉ văn phòng: 350-352 Võ Văn Kiệt, Phường Cô Giang, Quận 1, Thành phố Hồ Chí Minh,
