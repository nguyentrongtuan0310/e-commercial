...
export const CartSlice = createSlice({
    ...
    initialState: {
        listCart: {
            item: JSON.parse(localStorage.getItem('quanity'))?.data,
            totalItem: JSON.parse(localStorage.getItem('quanity'))?.value || 0,
            totalPrice: [],
        },
    },
    reducers: {
                ...
                if (index < 0) {
                    return {
                        ...
                        listCart: {
                            ...state.listCart,
                            totalPrice: [
                                ...state.listCart.totalPrice,
                                { item: action.payload.item, countTotal: action.payload.countTotal + 1 },
                            ],
                        },
                    };
                } else {
                ...
                if (index < 0) {
                    return {
                        ...
                        listCart: {
                            ...
                            totalPrice: [
                                ...state.listCart.totalPrice,
                                { item: action.payload.item, countTotal: action.payload.countTotal },
                            ],
                        },
                    };
                } else {
