...
import ProductSwiper from "../Products/components/SaleProduct/ProductSwiper/ProductSwiper";
import { fetchProduct } from "../Products/components/productSlice";
import Info from "./Info/Info";
import {CheckIcon} from '../../components/Icon'
import useResize from "../../hooks/useResize";
import MenuBottom from "../../components/HomeLayout/MenuBottom/MenuBottom";
              ...
              <Col lg={{ span: 14 }} md={{ span: 24 }} sm={{ span: 24 }} className={styles.side__right}>
                ...
                <div className={styles.box}>
                  <div className={styles.box__order}>
                    ...
                    <div
                      className={styles.box__order__icon}
                ...
                <div className={styles.promotion}>
                  ...
                  <ul className={styles.promotion__list}>
                    ...
                    <li className={styles.promotion__item}>
                      <a>
                        Mở thẻ UOB - Nhận Evoucher tới 3 triệu mua hàng tại
                        CellphoneS{" "}
                      </a>
                    </li>
                    <li className={styles.promotion__item}>
                      ...
                      <a>
                        Mở thẻ tín dụng VIB - Nhận voucher 200.000đ mua hàng tại
                        CellphoneS
                      </a>
                    </li>
                    <li className={styles.promotion__item}>
                      <a>
                        Thu cũ đổi mới: Giá thu cao - Thủ tục nhanh chóng - Trợ
                        giá tốt nhất
                      </a>
                    </li>
                  </ul>
